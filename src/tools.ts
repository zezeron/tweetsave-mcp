/**
 * TweetSave MCP Server - Shared Tool Definitions
 *
 * Registers all tools on an McpServer instance.
 * Used by both stdio (index.ts) and HTTP (http-server.ts) transports.
 */
